    ...
    <div className="bg-green-950 text-green-50 px-10 w-full">
      <Container className="pb-48 pt-36 md:pt-44 text-center">
        ...
        <motion.button
          ...
          className="px-4 py-2 md:px-5 md:py-3 text-sm md:text-base bg-orange-600 hover:bg-orange-500/95 mb-7"
        >
          Start Today
        </motion.button>
        <div>
          <motion.div
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2 md:px-5 md:py-3 text-sm md:text-base hover:bg-green-900 cursor-pointer transition-colors"
          >
            <svg
              width="32"
              height="32"
